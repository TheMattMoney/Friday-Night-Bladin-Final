...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['tweenINHud', 'self explanatory'],
		['Dragons', 'haha'],
		['FinalClash', 'Begins the final clash event'],
		['EndFinalClash', 'yea'],
		['DramaticCamera', 'Cool'],
		['tweenOUTHud', 'yea'],
		['MoveCamtoDad', "Moves and Focuses the camera on ryuga\n put twice to focus on bf."],
		['lightShow', "leave val 1 and 2 empty for random bolts\nfill it with either 0,1,2,3 for set bolts\nval 2 is for the animation number it can be either 0,1,2"],
		['lightShowFar', "leave val 1 and 2 empty for random bolts\nfill it with either 0,1,2,3 for set bolts\nval 2 is for the animation number it can be either 0,1,2"],
		['beyShowDown', "press Space bro"],
